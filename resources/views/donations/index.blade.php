...
<head>
    ...
    <title>Admin Dashboard - Liste des donations</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="col-12">
            ...
            <div class="card-body">
                <h5 class="card-title">Toutes les donations</h5>
                    ...
                    <tbody>
                        @foreach ($donations as $donation)
                            <tr>
                                ...
                                <td>
                                    @if ($donation->receiver_type == 'platform')
                                        <span class="badge bg-success">platform</span>
                                    @elseif ($donation->receiver_type == 'consultant')
                                        <span class="badge bg-info">consultant</span>
                                    @endif
                                </td>
                                <td>
                                    <span class="badge bg-primary">{{ $donation->donator->name }}</span>
                                </td>
                                <td>
                                    <span class="badge bg-info">{{ $donation->receiver->name }}</span>
                                </td>
                                <td>
